...
class Client(models.Model):
    ...
    interval_from = models.TimeField(blank=True, null=True, verbose_name='Business interval from')
    interval_to = models.TimeField(blank=True, null=True, verbose_name='Business interval to')
